...
//                Toast.makeText(getApplicationContext(), "DEAD", Toast.LENGTH_SHORT).show();
        ...
        if (wizardY > plat1.getY() - wiz.getHeight() && wizardX < plat1.getWidth()) wizardY = plat1.getY() - wiz.getHeight();
        if (wizardY > plat2.getY() - wiz.getHeight() && wizardX + wiz.getWidth() > plat2.getY()) wizardY = plat2.getY() - wiz.getHeight();
